    ...
    def connect(self, mfa_callback=None):
        ...
        try:
            ...
            self.client.connect(
                ...
                allow_agent=False,
                look_for_keys=False,
                timeout=60 # Aumentado para 60 para dar folga ao DUO auto-push!
            )
            self.is_connected = True
            return True, "Conexão estabelecida com sucesso."
            
        except paramiko.ssh_exception.AuthenticationException:
            # O Login negou porque exige `Keyboard-Interactive` (O prompt do DUO explícito)!
            try:
                ...
                try:
                    ...
                    server_questions = "Log não gerado (Provavelmente a senha estava incorreta ou o DUO Auto-Push expirou)."
