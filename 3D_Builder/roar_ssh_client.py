...
class RoarSSHClient:
    ...
    def upload_file(self, local_path, remote_path):
        ...
        for attempt in range(3):
            try:
                ...
                stdin, stdout, stderr = self.client.exec_command(cmd, timeout=300.0)
                ...
                stdout.channel.settimeout(300.0)
    ...
    def submit_job(self, sbatch_file_path):
        ...
        try:
            ...
            stdin, stdout, stderr = self.client.exec_command(command, get_pty=True, timeout=300.0)
            stdout.channel.settimeout(300.0)
