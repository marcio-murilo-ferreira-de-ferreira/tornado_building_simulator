    ...
    def _strategy_block(self, candidate: RetrofitCandidate) -> str:
        ...
        if candidate.strategy == "A":
            ...
            return (
                ...
                "p_rod.seedPart(size=0.01, deviationFactor=0.1, minSizeFactor=0.1)\n"
                "p_rod.generateMesh()\n"
        ...
        if candidate.strategy == "B":
            ...
            return (
                ...
                "p_plate.seedPart(size=0.01, deviationFactor=0.1, minSizeFactor=0.1)\n"
        ...
        if candidate.strategy == "D":
            ...
            return (
                ...
                "p_strap.seedPart(size=0.01, deviationFactor=0.1, minSizeFactor=0.1)\n"
        ...
        if candidate.strategy == "E":
            ...
            return (
                ...
                "p_up.seedPart(size=0.01, deviationFactor=0.1, minSizeFactor=0.1)\n"
                "p_scr.seedPart(size=0.01, deviationFactor=0.1, minSizeFactor=0.1)\n"
