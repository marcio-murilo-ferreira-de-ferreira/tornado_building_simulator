...
s_up.rectangle(point1=(0.0, 0.0), point2=(0.1757598741809907, 0.1757598741809907))
p_up = model.Part(name='AnchorUpliftPlate', dimensionality=THREE_D, type=DEFORMABLE_BODY)
p_up.BaseSolidExtrude(sketch=s_up, depth=0.01419378855804827)
...
a.translate(instanceList=('AnchorUpliftPlate-1',), vector=(0.06452006290950463, 1.1789450629095048, 0.0254))
s_scr = model.ConstrainedSketch(name='uplift_screw_sk', sheetSize=2.0)
s_scr.rectangle(point1=(0.0, 0.0), point2=(0.007330736060931195, 0.15239999999999998))
p_scr = model.Part(name='AnchorScrew', dimensionality=THREE_D, type=DEFORMABLE_BODY)
p_scr.BaseSolidExtrude(sketch=s_scr, depth=0.007330736060931195)
