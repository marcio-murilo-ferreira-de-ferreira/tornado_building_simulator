...
s_rod.rectangle(point1=(0.0, 0.0), point2=(0.022880683112956646, 1.1897314845575742))
p_rod = model.Part(name='AnchorRod', dimensionality=THREE_D, type=DEFORMABLE_BODY)
p_rod.BaseSolidExtrude(sketch=s_rod, depth=0.022880683112956646)
...
a.translate(instanceList=('AnchorRod-1',), vector=(0.17145, 0.33426851544242586, 0.2032))
...
job = mdb.Job(name='retrofit_a', model=MODEL_NAME, type=ANALYSIS, explicitPrecision=SINGLE)
job.writeInput()
inp_name = 'retrofit_a.inp'
