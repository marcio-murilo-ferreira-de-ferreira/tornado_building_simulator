...
MODEL_NAME = "Sensitivity_B_combo_best"
...
model.ExplicitDynamicsStep(name='GustStep', previous='Initial', timePeriod=0.100000)
...
p_plate.seedPart(size=0.112500, deviationFactor=0.1, minSizeFactor=0.1)
p_bolt.seedPart(size=0.112500, deviationFactor=0.1, minSizeFactor=0.1)
...
p_wall.seedPart(size=0.187500, deviationFactor=0.1, minSizeFactor=0.1)
p_joist.seedPart(size=0.150000, deviationFactor=0.1, minSizeFactor=0.1)
p_wall.generateMesh()
...
job = mdb.Job(name='sens_b_combo_best', model=MODEL_NAME, type=ANALYSIS, explicitPrecision=SINGLE)
job.writeInput()
