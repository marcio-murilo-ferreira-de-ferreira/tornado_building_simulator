...
s_hng.rectangle(point1=(0.0, 0.0), point2=(0.0031609847305039784, 0.23495))
p_hng = model.Part(name='Hanger', dimensionality=THREE_D, type=DEFORMABLE_BODY)
p_hng.BaseSolidExtrude(sketch=s_hng, depth=0.0635)
...
a.translate(instanceList=('Hanger-1',), vector=(0.149239015269496, 1.14935, 0.0254))
...
p_blk.BaseSolidExtrude(sketch=s_blk, depth=0.4004244278868497)
...
a.translate(instanceList=('HangerBlock-1',), vector=(0.15239999999999998, 1.14935, 0.38099999999999995))
p_hng.seedPart(size=0.01, deviationFactor=0.1, minSizeFactor=0.1)
...
# fastener count proxy retained for reporting: 15
...
job = mdb.Job(name='retrofit_h', model=MODEL_NAME, type=ANALYSIS, explicitPrecision=SINGLE)
job.writeInput()
inp_name = 'retrofit_h.inp'
