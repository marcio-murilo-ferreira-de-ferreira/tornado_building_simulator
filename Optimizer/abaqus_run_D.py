...
s_strap.rectangle(point1=(0.0, 0.0), point2=(0.04493568657567845, 0.24014921473444498))
p_strap = model.Part(name='AnchorStrap', dimensionality=THREE_D, type=DEFORMABLE_BODY)
p_strap.BaseSolidExtrude(sketch=s_strap, depth=0.005000466425558333)
...
a.translate(instanceList=('AnchorStrap-1',), vector=(0.12993215671216074, 1.0893126963163888, 0.16764))
...
job = mdb.Job(name='retrofit_d', model=MODEL_NAME, type=ANALYSIS, explicitPrecision=SINGLE)
job.writeInput()
inp_name = 'retrofit_d.inp'
