...
s_pin.rectangle(point1=(0.0, 0.0), point2=(0.01499638584021384, 0.3646179106453702))
p_pin = model.Part(name='HybridPin', dimensionality=THREE_D, type=DEFORMABLE_BODY)
p_pin.BaseSolidExtrude(sketch=s_pin, depth=0.01499638584021384)
...
a.translate(instanceList=('HybridPin-1',), vector=(0.17145, 1.061021044677315, 0.2032))
s_hold = model.ConstrainedSketch(name='hy_hold_sk', sheetSize=2.0)
s_hold.rectangle(point1=(0.0, 0.0), point2=(0.0037800102744685363, 0.3807445861673111))
...
a.translate(instanceList=('HybridHoldown-1',), vector=(0.14861998972553145, 1.14935, 0.09652))
...
p_blk.BaseSolidExtrude(sketch=s_blk, depth=0.4648798943617304)
