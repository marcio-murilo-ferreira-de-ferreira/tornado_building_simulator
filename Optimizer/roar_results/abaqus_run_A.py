...
s_rod.rectangle(point1=(0.0, 0.0), point2=(0.02135616908166301, 1.4782430329502143))
p_rod = model.Part(name='AnchorRod', dimensionality=THREE_D, type=DEFORMABLE_BODY)
p_rod.BaseSolidExtrude(sketch=s_rod, depth=0.02135616908166301)
...
a.translate(instanceList=('AnchorRod-1',), vector=(0.17145, 0.04575696704978571, 0.2032))
