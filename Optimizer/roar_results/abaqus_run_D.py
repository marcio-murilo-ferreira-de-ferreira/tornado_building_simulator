...
s_strap.rectangle(point1=(0.0, 0.0), point2=(0.05071416043155122, 0.2377472252166115))
p_strap = model.Part(name='AnchorStrap', dimensionality=THREE_D, type=DEFORMABLE_BODY)
p_strap.BaseSolidExtrude(sketch=s_strap, depth=0.0051097050282784655)
...
a.translate(instanceList=('AnchorStrap-1',), vector=(0.12704291978422438, 1.0899131936958473, 0.16764))
