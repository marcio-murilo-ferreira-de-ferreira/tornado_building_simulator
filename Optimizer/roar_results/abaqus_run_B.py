...
s_plate.rectangle(point1=(0.0, 0.0), point2=(0.24599133438782106, 0.24599133438782106))
...
s_bolt.rectangle(point1=(0.0, 0.0), point2=(0.02070894912979306, 0.23495))
p_bolt = model.Part(name='AnchorBolt', dimensionality=THREE_D, type=DEFORMABLE_BODY)
p_bolt.BaseSolidExtrude(sketch=s_bolt, depth=0.02070894912979306)
