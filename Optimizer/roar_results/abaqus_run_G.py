...
s_hold.rectangle(point1=(0.0, 0.0), point2=(0.005442471759507961, 0.4461510911903938))
...
a.translate(instanceList=('Holdown-1',), vector=(0.14695752824049202, 1.14935, 0.06096))
s_bolt = model.ConstrainedSketch(name='holdown_bolt_sk', sheetSize=2.0)
s_bolt.rectangle(point1=(0.0, 0.0), point2=(0.01863827905053217, 0.15239999999999998))
p_bolt = model.Part(name='HoldownBolt', dimensionality=THREE_D, type=DEFORMABLE_BODY)
p_bolt.BaseSolidExtrude(sketch=s_bolt, depth=0.01863827905053217)
