...
s_pin.rectangle(point1=(0.0, 0.0), point2=(0.015875, 0.21666682922225583))
...
a.translate(instanceList=('AnchorPin-1',), vector=(0.17145, 1.1584915853888722, 0.2032))
...
job = mdb.Job(name='retrofit_c', model=MODEL_NAME, type=ANALYSIS, explicitPrecision=SINGLE)
job.writeInput()
inp_name = 'retrofit_c.inp'
