...
s_hold.rectangle(point1=(0.0, 0.0), point2=(0.007619999999999999, 0.508))
...
a.translate(instanceList=('Holdown-1',), vector=(0.14478, 1.14935, 0.06096))
s_bolt = model.ConstrainedSketch(name='holdown_bolt_sk', sheetSize=2.0)
s_bolt.rectangle(point1=(0.0, 0.0), point2=(0.019049999999999997, 0.15239999999999998))
p_bolt = model.Part(name='HoldownBolt', dimensionality=THREE_D, type=DEFORMABLE_BODY)
p_bolt.BaseSolidExtrude(sketch=s_bolt, depth=0.019049999999999997)
...
a.translate(instanceList=('HoldownBolt-1',), vector=(0.17145, 1.190625, 0.11429999999999998))
p_hold.seedPart(size=0.01, deviationFactor=0.1, minSizeFactor=0.1)
p_bolt.seedPart(size=0.01, deviationFactor=0.1, minSizeFactor=0.1)
...
job = mdb.Job(name='retrofit_unitcell', model=MODEL_NAME, type=ANALYSIS, explicitPrecision=SINGLE)
job.writeInput()
inp_name = 'retrofit_unitcell.inp'
