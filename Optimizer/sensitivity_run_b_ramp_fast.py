...
MODEL_NAME = "Sensitivity_B_ramp_fast"
...
model.ExplicitDynamicsStep(name='GustStep', previous='Initial', timePeriod=0.020000)
...
p_plate.seedPart(size=0.150000, deviationFactor=0.1, minSizeFactor=0.1)
p_bolt.seedPart(size=0.150000, deviationFactor=0.1, minSizeFactor=0.1)
...
job = mdb.Job(name='sens_b_ramp_fast', model=MODEL_NAME, type=ANALYSIS, explicitPrecision=SINGLE)
job.writeInput()
