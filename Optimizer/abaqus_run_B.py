...
s_plate.rectangle(point1=(0.0, 0.0), point2=(0.14439459127084953, 0.14439459127084953))
...
s_bolt.rectangle(point1=(0.0, 0.0), point2=(0.02394265102991412, 0.23495))
p_bolt = model.Part(name='AnchorBolt', dimensionality=THREE_D, type=DEFORMABLE_BODY)
p_bolt.BaseSolidExtrude(sketch=s_bolt, depth=0.02394265102991412)
...
job = mdb.Job(name='retrofit_b', model=MODEL_NAME, type=ANALYSIS, explicitPrecision=SINGLE)
job.writeInput()
inp_name = 'retrofit_b.inp'
