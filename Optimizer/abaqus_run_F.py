...
s_pin.rectangle(point1=(0.0, 0.0), point2=(0.01740350547538171, 0.3378148855219518))
p_pin = model.Part(name='HybridPin', dimensionality=THREE_D, type=DEFORMABLE_BODY)
p_pin.BaseSolidExtrude(sketch=s_pin, depth=0.01740350547538171)
...
a.translate(instanceList=('HybridPin-1',), vector=(0.17145, 1.074422557239024, 0.2032))
s_hold = model.ConstrainedSketch(name='hy_hold_sk', sheetSize=2.0)
s_hold.rectangle(point1=(0.0, 0.0), point2=(0.005165145050412353, 0.4102219462341918))
p_hold = model.Part(name='HybridHoldown', dimensionality=THREE_D, type=DEFORMABLE_BODY)
p_hold.BaseSolidExtrude(sketch=s_hold, depth=0.038099999999999995)
...
a.translate(instanceList=('HybridHoldown-1',), vector=(0.14723485494958763, 1.14935, 0.09652))
s_blk = model.ConstrainedSketch(name='hy_block_sk', sheetSize=2.0)
s_blk.rectangle(point1=(0.0, 0.0), point2=(0.038099999999999995, 0.23495))
p_blk = model.Part(name='HybridBlock', dimensionality=THREE_D, type=DEFORMABLE_BODY)
p_blk.BaseSolidExtrude(sketch=s_blk, depth=0.5724658442564502)
...
a.translate(instanceList=('HybridBlock-1',), vector=(0.15239999999999998, 1.14935, 0.38099999999999995))
p_pin.seedPart(size=0.01, deviationFactor=0.1, minSizeFactor=0.1)
p_hold.seedPart(size=0.01, deviationFactor=0.1, minSizeFactor=0.1)
p_blk.seedPart(size=0.01, deviationFactor=0.1, minSizeFactor=0.1)
...
p_wall.seedPart(size=0.01, deviationFactor=0.1, minSizeFactor=0.1)
p_joist.seedPart(size=0.01, deviationFactor=0.1, minSizeFactor=0.1)
p_wall.generateMesh()
...
job = mdb.Job(name='retrofit_f', model=MODEL_NAME, type=ANALYSIS, explicitPrecision=SINGLE)
job.writeInput()
inp_name = 'retrofit_f.inp'
