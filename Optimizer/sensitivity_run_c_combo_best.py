...
MODEL_NAME = "Sensitivity_C_combo_best"
...
p_pin.seedPart(size=0.112500, deviationFactor=0.1, minSizeFactor=0.1)
p_pin.generateMesh()
...
job = mdb.Job(name='sens_c_combo_best', model=MODEL_NAME, type=ANALYSIS, explicitPrecision=SINGLE)
job.writeInput()
