...
start "" /B streamlit run "%USERPROFILE%\Desktop\Tornado_Building_Simulator\Optimizer\interactive_sim_ui.py" --server.port 8501
timeout /t 3 >nul

echo Iniciando o Construtor 3D (Tela 2) na porta 8502 em background...
start "" /B streamlit run "%USERPROFILE%\Desktop\Tornado_Building_Simulator\3D_Builder\app.py" --server.port 8502
