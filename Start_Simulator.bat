...
echo Iniciando o Construtor 3D (Tela 2) na porta 8502 em background (silencioso)...
start "" /B streamlit run "%~dp03D_Builder\app.py" --server.port 8502 --server.headless true
timeout /t 3 >nul
